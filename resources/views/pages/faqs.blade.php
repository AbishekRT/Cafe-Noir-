...
<x-app-layout>
    ...
    <section class="relative bg-primary py-16">
        <div class="container mx-auto px-4 text-center">
            <h1 class="text-4xl md:text-5xl font-heading font-bold text-secondary mb-4">Frequently Asked Questions</h1>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            <div class="mb-12 flex flex-wrap justify-center gap-4">
                <a href="#ordering"
                    class="px-4 py-2 bg-secondary text-primary rounded-full text-sm font-medium hover:bg-accent transition-colors">
                    Ordering
                </a>
                <a href="#shipping"
                    class="px-4 py-2 bg-secondary text-primary rounded-full text-sm font-medium hover:bg-accent transition-colors">
            ...
            <div id="ordering" class="mb-12">
                <h2 class="text-2xl font-heading font-bold text-heading mb-6 flex items-center">
                    <span class="w-10 h-10 bg-accent rounded-lg flex items-center justify-center mr-3">
                ...
                <div class="space-y-4" x-data="{ open: null }">
                    ...
                    <div class="border border-primary/10 rounded-lg overflow-hidden">
                        <button @click="open = open === 1 ? null : 1"
                            class="w-full px-6 py-4 text-left flex items-center justify-between bg-secondary hover:bg-secondary/80 transition-colors">
    ...
    <section class="py-16 bg-secondary">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-2xl font-heading font-bold text-heading mb-4">Still Have Questions?</h2>
            <p class="text-body max-w-xl mx-auto mb-8">
                Can't find the answer you're looking for? Our customer support team is here to help!
            </p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('pages.contact') }}"
                    class="inline-flex items-center justify-center px-6 py-3 bg-primary text-secondary font-semibold rounded-lg hover:bg-primary/90 transition-colors">
                ...
                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', config('cafe.contact.whatsapp')) }}"
                    ...
                    class="inline-flex items-center justify-center px-6 py-3 bg-green-500 text-white font-semibold rounded-lg hover:bg-green-600 transition-colors">
