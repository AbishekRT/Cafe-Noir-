...
--}}
<footer class="footer-modern text-white mt-16">
    <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div class="space-y-5">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <span class="block text-xs tracking-wider"
                            style="color: rgba(201,162,77,0.7); letter-spacing: 0.15em;">PREMIUM COFFEE</span>
                    </div>
                </div>
                <p class="text-sm leading-relaxed" style="color: rgba(245,239,230,0.6);">
                ...
                <div class="flex space-x-3 pt-2">
                    <a href="{{ config('cafe.social.facebook') }}" target="_blank" rel="noopener"
                        ...
                        style="background: rgba(255,255,255,0.08); color: rgba(245,239,230,0.7);"
                        onmouseover="this.style.background='#C9A24D'; this.style.color='#2E1F1A';"
                        onmouseout="this.style.background='rgba(255,255,255,0.08)'; this.style.color='rgba(245,239,230,0.7)';">
            ...
            <!-- Quick Links -->
            <div>
                <h4 class="font-heading text-base font-semibold text-accent mb-5 tracking-wide"
                    style="letter-spacing: 0.05em;">QUICK LINKS</h4>
                <ul class="space-y-3">
                    @php
                        $footerLinks = [
                            ['route' => 'home', 'label' => 'Home'],
                            ['route' => 'shop.index', 'label' => 'Shop'],
                            ['route' => 'pages.about', 'label' => 'About Us'],
                            ['route' => 'pages.faqs', 'label' => 'FAQs'],
                            ['route' => 'pages.contact', 'label' => 'Contact Us'],
                        ];
                    @endphp
                    @foreach($footerLinks as $link)
                        <li>
                            <a href="{{ route($link['route']) }}"
                                class="text-sm transition-colors duration-200 hover:text-accent flex items-center group"
                                style="color: rgba(245,239,230,0.6);">
                                <span
                                    class="w-0 group-hover:w-3 h-px bg-accent transition-all duration-200 mr-0 group-hover:mr-2"></span>
                                {{ $link['label'] }}
                            </a>
                        </li>
                    @endforeach
            ...
            <div>
                <h4 class="font-heading text-base font-semibold text-accent mb-5 tracking-wide"
                    style="letter-spacing: 0.05em;">CONTACT US</h4>
                <ul class="space-y-4 text-sm">
                    <li class="flex items-start space-x-3">
                        ...
                        <span style="color: rgba(245,239,230,0.6);">{{ config('cafe.contact.address') }}</span>
                    </li>
                    <li class="flex items-center space-x-3">
                        ...
                        <span style="color: rgba(245,239,230,0.6);">{{ config('cafe.contact.phone') }}</span>
                    </li>
                    <li class="flex items-center space-x-3">
                        <svg class="w-5 h-5 text-accent flex-shrink-0" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                        ...
                        <span style="color: rgba(245,239,230,0.6);">{{ config('cafe.contact.email') }}</span>
                    </li>
                </ul>
            </div>
            ...
            <div>
                <h4 class="font-heading text-base font-semibold text-accent mb-5 tracking-wide"
                    style="letter-spacing: 0.05em;">OPENING HOURS</h4>
                <div class="space-y-3 text-sm" style="color: rgba(245,239,230,0.6);">
                    <div class="flex justify-between">
                        <span>Monday - Friday</span>
                        <span class="text-white font-medium">8AM - 6PM</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Saturday</span>
                        <span class="text-white font-medium">9AM - 5PM</span>
                    </div>
                    <div class="flex justify-between">
                        <span>Sunday</span>
                ...
                <div class="mt-6 p-4 rounded-lg"
                    style="background: rgba(201,162,77,0.08); border: 1px solid rgba(201,162,77,0.15);">
                    <p class="text-xs" style="color: rgba(245,239,230,0.5);">
                        Online orders processed <span class="text-accent font-medium">24/7</span>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="mt-12 pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0"
            ...
            <p class="text-sm" style="color: rgba(245,239,230,0.4);">
                &copy; {{ date('Y') }} Cafe Noir. All rights reserved.
            </p>
            <p class="text-sm" style="color: rgba(245,239,230,0.4);">
                Crafted with care by <a href="#"
                    class="text-accent hover:text-white font-semibold transition-colors">Nexora Solutions</a>
            </p>
        </div>
    </div>
</footer>